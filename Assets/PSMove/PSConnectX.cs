...
public class PSConnectX : MonoBehaviour
{
	...
	#region GUI Variables
		...
		void OnGUI ()
		{
				if (!PSMoveInput.IsConnected) {
						...
						if (PSMoveInput.MoveControllers [controllerNumber].Connected) {
								//								//Set Color and Track
								...
								if (GUI.Button (new Rect (550, 30, 160, 35), "SetColorAndTrack")) {
										try {
												...
												PSMoveInput.MoveControllers [controllerNumber].SetColorAndTrack (new Color (r, g, b));
										} catch (Exception e) {
								...
								//												PSMoveInput.MoveControllers [controllerNumber].SetRumble (rumbleValue);
								//										} catch (Exception e) {
								//												Debug.Log ("input problem");
								//										}
								//								}
